...
/*     */ {
	...
	/*     */ public boolean nextPage(int pageNumber) {
		...
		/*     */ catch (Exception e) {
			...
			/*     */ } finally {
			/* 59 */ DBManager.close(conn, pstmt, rs);
		}
	...
	/*     */ public List<BoardVo> getList(int pageNumber) {
		...
		/*     */ try {
			...
			/* 202 */ while (rs.next()) {
				...
				/* 206 */ bVo.setTitle(title);
				/* 207 */ bVo.setContent(rs.getString("content"));
						String boarddate = rs.getString("boarddate");
						boarddate = boarddate.substring(0, 11);
				/* 208 */ bVo.setBoarddate(boarddate);
	...
	public int recommend(String id, String boardid, int status) {
		String sql = "INSERT INTO recommend VALUES(?, ?, ?, ?)";
		Connection conn = null;
		PreparedStatement pstmt = null;
		String recumNum = boardid + id;
		try {
	...
	public int getRecommend(String id, String boardid) {
		String sql = "SELECT status FROM recommend WHERE id=? AND boardid=?";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try {
	...
	public int getRecommendUpCount(String boardid) {
		String sql = "select count(*) from recommend where boardid=? and status=1";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try {
	...
	public int getRecommendDownCount(String boardid) {
		String sql = "select count(*) from recommend where boardid=? and status=2";
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try {
